...
export { default as ProfileContent } from '@/components/profile-content/ProfileContent';
export { default as SettingsContent } from '@/components/settings-content/SettingsContent';
